...
class User:
    def __init__(self, name, surname, age, country, gender, profession=None):
        self.name = name
    ...
    def prof_teacher():
        return User.generate_user(profession="Teacher")


    def prof_doctor():
        return User.generate_user(profession="Doctor")


    def prof_policeman():
        return User.generate_user(profession="Policeman")
